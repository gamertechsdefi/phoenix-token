    ...
    <body>
      ...
      <main className="px-8 md:px-16">
        ...
        <div className="flex md:w-[50%]">
              <Image className="justify-center" src={webpfp} width={600} height={200} />
            </div>
          <div className="text-center m-auto md:text-left text-4xl md:text-7xl md:w-[50%]"
            style={{
              fontFamily: "Zen Dots",
            }}
          >
        ...
        {/* About Section */}
        <section className="mt-16 h-auto sm:h-screen ">
